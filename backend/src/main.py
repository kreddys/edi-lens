...
from src.api.endpoints import auth, schemas, edi_validation, ta1_generation, edi_parsing, schema_validation
...
api_router.include_router(edi_parsing.router, tags=["EDI Processing"])
api_router.include_router(schema_validation.router, tags=["Schema Management"])
